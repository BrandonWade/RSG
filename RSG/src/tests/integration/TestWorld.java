...
public class TestWorld extends TestCase
{
	...
	{
		System.out.println("\nStarting intergration test maps loaded...");
	...
	{
		System.out.println("\nStarting intergration test get super map value...");
	...
	{
		System.out.println("\nStarting intergration test load new supermap...");
		World.set(1,1);
	...
	{
		System.out.println("\nStarting intergration test get super map direction...");
		World.set(1,1);
	...
	{
		System.out.println("\nStarting intergration test get set super map...");
	...
	{
		System.out.println("\nStarting intergration test map sizing");
	...
	{
		System.out.println("\nStarting intergration test map filled...");
